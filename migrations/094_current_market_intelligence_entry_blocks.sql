-- Deterministic current intelligence entry blockers derived only from immutable history.
CREATE VIEW current_market_intelligence_entry_blocks AS
SELECT
    mia.assessment_id,
    mia.event_id,
    mia.policy_version,
...
WHERE mia.disposition <> 'OBSERVE_ONLY'
  AND (
