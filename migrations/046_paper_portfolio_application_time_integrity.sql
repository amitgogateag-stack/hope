-- PAPER portfolio application history must not move backward in source fill time.
...
CREATE TRIGGER trg_paper_portfolio_application_time_integrity
BEFORE INSERT ON paper_portfolio_fill_applications
FOR EACH ROW EXECUTE FUNCTION hope_enforce_paper_portfolio_application_time();
