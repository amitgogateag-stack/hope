    ...
    def from_state(
        ...
        *,
        ...
        for instrument_id, position in state.positions.items():
            ...
            if not position.average_price.is_finite():
                raise ValueError("PORTFOLIO_POSITION_AVERAGE_PRICE_MUST_BE_FINITE")
            ...
            if not position.realized_pnl.is_finite():
                raise ValueError("PORTFOLIO_REALIZED_PNL_MUST_BE_FINITE")
