...
def _result(*, cash: Decimal = Decimal("100.00")) -> BacktestResult:
    ...
    valuation = PortfolioValuation(at, cash, Decimal("41"), Decimal("1"), Decimal("0"), Decimal("0.30"), cash + Decimal("41"), Decimal("41"))
    metrics = BacktestMetrics(Decimal("100"), cash + Decimal("41"), Decimal("41"), Decimal("0.41"), Decimal("0.1"), Decimal("0.2"), Decimal("1.5"), Decimal("0.1"), Decimal("2"))
...
def test_backtest_evidence_is_versioned_json_and_canonicalizes_domain_scalars() -> None:
    ...
    assert projected["schema"] == BACKTEST_EVIDENCE_SCHEMA
