...
def test_restore_rejects_open_position_without_positive_average_price():
    instrument = uuid4()
    state = PortfolioState(
        cash=Decimal("1000"),
        positions={
...
def test_restore_rejects_negative_total_commission():
    instrument = uuid4()
    state = PortfolioState(
        cash=Decimal("1000"),
        positions={
...
def test_restore_rejects_non_finite_position_quantity():
    instrument = uuid4()
    state = PortfolioState(
        cash=Decimal("1000"),
        positions={
...
def test_restore_rejects_non_finite_total_commission():
    instrument = uuid4()
    state = PortfolioState(
        cash=Decimal("1000"),
        positions={
