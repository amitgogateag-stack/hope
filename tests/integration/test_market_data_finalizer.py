...
def test_market_data_finalizer_verifies_exact_coverage_before_sealing() -> None:
    ...
    with engine.connect() as connection:
        ...
        try:
            ...
            requests = (_request(t0), _request(t1))
            ...
            with pytest.raises(ValueError, match="PERSISTED_COVERAGE_MISSING"):
                finalizer.finalize(version_id, requests, identity_map=identity_map)
